...
public class HighLevelProduct {
    ...
    public HighLevelProduct() {
    }

    public HighLevelProduct(HighLevelProduct other) {
        ...
        this.archivedTimestamp = other.archivedTimestamp;
        ...
        this.downloadProductId = other.downloadProductId;
        this.quickLookPath = other.quickLookPath;
