...
public class StepRepository extends NonMappedRepository<Step> {
    ...
    public int saveLog(String stepName, int taskId, String nodeName, long duration, String log, String error) {
        ...
        return jdbcTemplate.update("INSERT INTO public.step_resource_log (step_name, task_id, node_name, entry_timestamp, duration_ms, stdout_text, stderr_text) " +
                                           "VALUES (?,?,?,?,?,?,?)",
    ...
    protected String insertQuery() {
        return "INSERT INTO public.step(name, task_id, parameters, submit_timestamp, start_timestamp, end_timestamp, exit_code, status_id, status_timestamp) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    }

    @Override
    protected String updateQuery() {
        return "UPDATE public.step " +
    ...
    protected String deleteQuery() {
        return "DELETE FROM public.step WHERE name=? AND task_id=?";
    }
