...
public final class ConfigurationKeys {
    ...
    public static final String DOWNLOADER_SENSOR_QUERY_BUFFER = "downloader.%s.query.days.back";
    ...
    public static final String DOWNLOADER_QUERY_TIMEOUT = "downloader.query.timeout";
    public static final String DOWNLOADER_ACTION_TIMEOUT = "downloader.timeout";
    public static final String DOWNLOADER_QUERY_DELAY = "downloader.query.delay";
    ...
    public static final String S1_DOWNLOAD_OFFSET = "processor.l2s1.temporal.offset";
    public static final String S1_MTF_INTERVAL = "processor.l2s1.temporal.filter.interval";
}
